...
class Mtce extends Application
{
	...
	private function show_page($tasks)
	{
		...
		$this->data['pagetitle'] = 'TODO List Maintenance ('. $role . ')' . ' - Group 12';
	...
	private function showit()
	{
	    ...
	    $fields = array(
	        ...
	        'fsize' => makeComboBox('Size', 'size', $task->size, $sizeparms, "What is the size of the task?"),
            'fgroup' => makeComboBox('Group', 'group', $task->group, $groupparms, "Which group is the task?"),
            'fstatus' => makeComboBox('Status', 'status', $task->status, $statusparms, "What is the status of the task?"),
